<script>
    $("#carrerasPasadas").addClass("active");
</script>
<br>
<?php if ($carrerasPasadas) { ?>
    <div class="container">
        <div class="card card-warning">
            <div class="card-header">
                <center>

                    <h3 class="card-title">Lista mis carreras pasadas</h3>
                </center>
                ...
                <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a href="<?php echo site_url("/ExcelController/generateCarrerasPasadas") ?>" style="color: white;"> Reporte en excel</a></i>
                    </button>
                    <button  type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a target="_blank" href="<?php echo site_url("/PdfController/generateCarrerasPasadas") ?>" style="color: white;">Reporte en pdf</a></i>
                    </button>
                </div>
            </div>
            <div class="card-body p-0">
                ...
                <table class="table table-warning table-bordered table-striped table-hover" id="tbl">
                    ...
                    <tbody class="table-warning">
                        <?php foreach ($carrerasPasadas as $registro) { ?>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="callout callout-info">
                            ...
                            Actualmente no tiene carreras pasadas registradas a la fecha de hoy.
                        </div>
