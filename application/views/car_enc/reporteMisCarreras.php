...
<?php if (!empty($carreras)) { ?>
        ...
        <div class="card card-solid">
            <div class="card-body pb-0">
                <div class="row">
                    <center>
                        <h4>PETICIONES DE CARRERAS</h4><br>
                    </center>
                            ...
                            <div class="card bg-light d-flex flex-fill">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                            ...
                                            <div class="col-4">
                                            <a href="<?php echo site_url('Carerras_encomiendas_controller/AceptarCarrera/'.$registro->id_car); ?>" class="btn btn-warning">Aceptar</a>
                                            ...
                                            <br><br> <a name="" id="" class="btn btn-danger" href="<?php echo site_url('Carerras_encomiendas_controller/RechazarCarrera/'.$registro->id_car); ?>" role="button">FINALIZADO</a>
                                            </div>
                                            <div class="col-4">
                                                <a name="" id="" class="btn btn-danger" href="<?php echo site_url('Carerras_encomiendas_controller/RechazarCarrera/'.$registro->id_car); ?>" role="button">Rechazar</a>
