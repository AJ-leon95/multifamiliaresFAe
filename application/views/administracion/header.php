                    ...
                    <li class="nav-item <?php echo $active_class('servicios'); ?> " id="servicios">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (
                                ...
                                <li class="nav-item">
                                    <a id="menu_encomiendas" href="<?php echo site_url("Carerras_encomiendas_controller/reporteMisEncomiendas/") ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if (
                                    ...
                                    <li class="nav-item">
                                        <a id="carrerasPasadas" href="<?php echo site_url("Carerras_encomiendas_controller/reportesCarrerasPasadas") ?>" class="nav-link">
                                            <i class="fas fas fa-bell"></i>
                                            <p>
                                                Mis carreras pasadas
                                            </p>
                                        </a>
                                    </li>
                                <?php } ?>
